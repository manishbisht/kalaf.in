    ...
    <section className={styles.section}>
      <div className="container">
        <div className="section-head" style={{ alignItems: 'flex-end' }}>
          <div>
            <div className="eyebrow" style={{ color: 'var(--smoke)' }}>
              Why Kalaf
            </div>
            <h2 style={{ color: 'var(--off-white)' }}>
              Six promises.
              <br />
              <span style={{ color: 'var(--smoke)' }}>No exceptions.</span>
            </h2>
          </div>
          <div className="right" style={{ color: 'var(--smoke)' }}>
            Every garment that leaves the workshop passes a six-point review against the standards
            below.
          </div>
        </div>
