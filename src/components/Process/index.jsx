        ...
        <div className="section-head">
          <div>
            <div className={styles.eyebrowRow}>
              <span className={styles.eyebrowText}>The making</span>
          ...
          <div className="right">
            Every Kalaf piece is sourced, woven, cut, and finished within 25 km of our office in
            Jaipur. Four steps. Four people we know by name.
          </div>
        </div>
