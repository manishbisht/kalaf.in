...
const data = {
  ...
  title: 'Care guide',
  ornament: 'देखभाल',
  summary: 'These pieces are made to last years. A little attention to washing and storing goes a long way.',
  updated: '23 May 2026',
  readTime: '3 min read',
  ...
  sections: [
    ...
    },
    {
      ...
      callout: { label: 'Temperature', value: 'Medium heat — cotton setting.' },
    },
    {
      id: 'storing',
      title: 'Storing',
    ...
    },
    {
      ...
      body: [
        ...
        {
          kind: 'p',
          text: "We're happy to advise on specific pieces — email hello@kalaf.in.",
        },
      ],
      callout: { label: 'Specific questions?', value: 'hello@kalaf.in' },
    },
  ],
}

export default function CareGuide() {
  return <PolicyLayout data={data} currentSlug="care-guide" crossLinks={HELP_CROSS_LINKS} />
}
