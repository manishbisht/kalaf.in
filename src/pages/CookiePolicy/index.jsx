...
const data = {
  ...
  title: 'Cookie policy',
  ornament: 'नियम',
  summary: 'We use a small number of cookies to keep the store working and to understand how people find us.',
  updated: '23 May 2026',
  readTime: '3 min read',
  sections: [
    {
    ...
    },
    {
      ...
      callout: { label: 'Questions about cookies?', value: 'hello@kalaf.in' },
    },
  ],
}

export default function CookiePolicy() {
  return <PolicyLayout data={data} currentSlug="cookies" crossLinks={POLICY_CROSS_LINKS} />
}
