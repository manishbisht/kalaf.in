...
const data = {
  ...
  title: 'Contact us',
  ornament: 'संपर्क',
  summary: "We're a small team in Jaipur. Email is fastest. We reply to every message within one working day.",
  updated: '23 May 2026',
  readTime: '1 min read',
  ...
  sections: [
    {
      ...
      callout: { label: 'Email', value: 'hello@kalaf.in' },
    },
    {
      id: 'include',
    ...
    },
    {
      ...
      callout: { label: 'Working hours', value: 'Mon–Sat, 10am–7pm IST.' },
    },
  ],
}

export default function Contact() {
  return <PolicyLayout data={data} currentSlug="contact" crossLinks={HELP_CROSS_LINKS} />
}
